...
In this capstone project, you will build all of the routing and database logic for an internal tool for a comic book publishing company called Shonen Jump Publishing.

The Shonen Jump Publishing internal tool should allow users to:
